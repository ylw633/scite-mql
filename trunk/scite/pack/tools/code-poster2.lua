...
--  (сборка Ru-Board, http://scite-ru.org)
---------------------------------------------------
require 'shell'
...
if line_start ~= 0 then
	header = header.." [s][[b]line "..line_start.."[/b]][/s]"
end
local more = ""
local more_end = ""
...
local reclam = ("Код создан и опубликован с помощью"):from_utf8(editor:codepage()) -- convert this string to the encoding of processed script
