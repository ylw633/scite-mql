...
//!-start-[caret]
	std::string tmp_str;
	tmp_str=props.GetNewExpandString("caret.fore.", fileNameForExtension.c_str());
...
//!-start-[caret]
	tmp_str=props.GetNewExpandString("caret.width.", fileNameForExtension.c_str());
	if(tmp_str.length()){
